    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewAbout.this,null,"لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_ABOUT);
                return s;
            }
        }
    ...
    private void msn(String json){
        try {
         ...
         //   editTextName.setText(post_title);
            ...
            htmlText =   "<html dir='rtl' lang=\\\"fa\\\"><head><style>img {\n" +
                    "   display: block;\n" +
                    " border-radius: 100%;\n"+
                          /* "width: 80%;"+*/
                    ...
                    "} p {margin:0;padding:0;font-size:14; text-align:justify; color:#000000;\n" +
                        /*    "    text-indent: -0px;\n" +*/
                           /* "  moisrexnumber();\n" +*/
                          /* " display: inline;"+
                            "  margin: auto;"+*/
