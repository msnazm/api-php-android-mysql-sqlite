...
public class Death extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void get_post_find(){
        class Get_posts extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Death.this,"اطلاعات...","لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s = rh.sendPostRequest(Config.URL_GET_FIND_Death,params);
                return s;
            }
        }
    ...
    private void msn_find(String json){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Death.this, list, R.layout.list_item,
    ...
    private void getJSONSortT(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Death.this,null,"لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_DeathSortT_ALL);
                return s;
            }
        }
    ...
    private void getJSONSortL(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_DeathSortL_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSONSortS(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_DeathSortLike_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSONSortE(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_DeathSortE_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_Death_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
