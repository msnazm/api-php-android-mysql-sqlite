...
public class SportsFitness extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void get_post_find(){
        class Get_posts extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SportsFitness.this,"اطلاعات...","لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s = rh.sendPostRequest(Config.URL_GET_FIND_SportsFitness,params);
                return s;
            }
        }
    ...
    private void msn_find(String json){
        ...
        ListAdapter adapter = new SimpleAdapter(
                SportsFitness.this, list, R.layout.list_item,
    ...
    private void getJSONSortT(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SportsFitness.this,null,"لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_SportsFitnessSortT_ALL);
                return s;
            }
        }
    ...
    private void getJSONSortL(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_SportsFitnessSortL_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSONSortS(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_SportsFitnessSortLike_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSONSortE(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_SportsFitnessSortE_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest(Config.URL_GET_SportsFitness_ALL);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
