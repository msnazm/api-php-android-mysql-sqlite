...
public class ViewNewspaper extends AppCompatActivity {
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewNewspaper.this,null,"لطفا صبر کنید...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_newspaper);
                return s;
            }
        }
