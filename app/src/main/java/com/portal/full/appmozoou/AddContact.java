    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            if (getWindow().getDecorView().getLayoutDirection() == View.LAYOUT_DIRECTION_LTR) {
                ...
                Intent intent = getIntent();
                //Initializing views
                editTextcomment_post_ID = (EditText) findViewById(R.id.editTextcomment_post_ID1);
                editTextcomment_author = (EditText) findViewById(R.id.editTextcomment_author1);
                editTextcomment_author_email = (EditText) findViewById(R.id.editTextcomment_author_emailary1);
                editTextcomment_content = (EditText) findViewById(R.id.editTextcomment_content1);
                //  clocktext = (TimePicker) findViewById(R.id.timePicker);
                editTextcomment_Date = (EditText) findViewById(R.id.editTextcomment_Date1);
              ...
              /*  buttonAdd.setOnClickListener(this);
                String html ="<p>ما در مجموعه شرکت  \" موضوع \"  همواره تلاش می کنیم مفیدترین بخش ها، مطالب و خبرها و در بروزرسانیهای دیگر ارائه نرم افزارهایی برای موضوع ها و ایجاد گذاشتن موضوع های مختلف توسط کاربرهای محترم  را برای شما محیا نماییم،نظرات خود را برای ما ارسال فرمایید و جهت ارتباط مستقیم با بخش های مختلف نرم افزار \" موضوع \" از راه های زیر استفاده نمایید:</p><br>" +
                        "<br>" +
                        "<p>email:info@mozoou.com</p><br>" +
                        "<p>Id Telegram @mozoou</p><br>" +
                        "<p>tel:0901-569-0718</p><br>" +
                        "<br>" +
                        "<p>و یا از طریق فرم زیر نظر خود را ارسال کنید.</p>";


                TextView tozih = (TextView) findViewById(R.id.txttozih);
               tozih.setText(Html.fromHtml(html,null,null));*/
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(Config.KEY_EMP_comment_post_ID,"3130");
    ...
    public void onClick(View v) {
        ...
        if(v == buttonAdd){
            ...
            if(strName.toString().length() < 3) {
             ...
             //   txterror.setText("لطفا نام  خود را وارد کنید حدافل 3 حرف.");
                Toast toast= Toast.makeText(AddContact.this, "لطفا نام  خود را وارد کنید حدافل 3 حرف.",
                        Toast.LENGTH_SHORT);
              ...
              //  editTextcomment_author_email.setError("لطفا ایمیل خود را وارد کنید. مثال: sample@gmail.com");
               // txterror.setText( "لطفا ایمیل خود را وارد کنید. مثال: sample@gmail.com");
                Toast toast= Toast.makeText(AddContact.this, "لطفا ایمیل خود را وارد کنید. مثال: sample@gmail.com",
               ...
               // txterror.setText("لطفا دیدگاه خود را وارد کنید حداقل 6 حروف");
              //  editTextcomment_content.setError("لطفا دیدگاه خود را وارد کنید حداقل 6 حروف");
                Toast toast= Toast.makeText(AddContact.this, "لطفا دیدگاه خود را وارد کنید حداقل 6 حروف",
                        Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 0);
                toast.setGravity(Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 0);
                toast.show();
          //  }else if(strStar.toString().equals("0")){
              // txtRatingValue.setError("لطفا امتیاز خود را تعیین کنید!");
                ...
                Toast.makeText(AddContact.this, "اطلاعات با موفقیت ثبت شد. ",
